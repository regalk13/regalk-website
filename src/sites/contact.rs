    ...
    return view! {
        ...
        <section class="contact-me--container">
            ...
            <div class="email--contact-me">
                <p>To ensure confidentiality and authenticity, I use GPG for email encryption and signing:</p>
                <ul>
                    <li>Public GPG Key (for encrypting messages to me): <code>"curl -sL https://keys.openpgp.org/vks/v1/by-email/contact%40regalk.dev | gpg --import"</code></li>
                    <li>"Fingerprint: C118 4893 ABEE 48F5 42DC  F312 272E B240 4D99 8FBF"</li>
                    <li>"(Important) All legitimate emails from me will be signed with my GPG key."</li>
                </ul>
            </div>
